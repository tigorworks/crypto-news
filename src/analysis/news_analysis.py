...
def sintesis(
    ...
    system = (
        ...
        "sertakan angka atau level konkret kalau itu inti temuannya. Di layar "
        "ponsel, judul 16 kata sudah memakan empat baris penuh sebelum "
        "pembaca sampai ke angkanya.\n"
        "    HARUS BISA DIBACA ORANG YANG TIDAK MENGIKUTI PASAR. Uji sendiri "
        "sebelum menulisnya: kalau judul ini dibacakan kepada orang yang "
        "belum pernah membuka grafik harga, apakah ia paham? Kalau tidak, "
        "tulis ulang.\n"
        "    SATU GAGASAN SAJA. Judul yang menempelkan sebab kedua dengan "
        "'tapi', 'sementara', atau 'meski' hampir selalu jadi berat dan "
        "kabur. Simpan sebab keduanya untuk `karakter_pergerakan`.\n"
        "    KOSAKATA — pakai yang kiri, JANGAN yang kanan:\n"
        "      'penutupan posisi jual'   BUKAN 'short covering', 'penutupan "
        "taruhan turun', 'short squeeze'\n"
        "      'posisi jual' / 'posisi beli'  BUKAN 'taruhan turun', "
        "'taruhan naik', 'posisi bearish'\n"
        "      'yang tadinya menjual'    BUKAN 'pedagang yang bertaruh harga "
        "turun', 'para short-seller'\n"
        "      'pembeli baru'            BUKAN 'permintaan riil', "
        "'permintaan organik', 'demand baru'\n"
        "      'penjualan paksa'         BUKAN 'likuidasi paksa massal', "
        "'forced liquidation'\n"
        "    Kata 'taruhan', 'bertaruh', dan 'pedagang' DILARANG di judul: "
        "bukan begitu orang Indonesia bicara soal pasar, dan hasilnya selalu "
        "terbaca dipaksakan. Singkatan teknis (OI, RSI, ATR, DVOL) juga "
        "dilarang di judul.\n"
        "    KONTRAS 'A, bukan B' hanya boleh kalau sisi B menjelaskan "
        "dirinya sendiri. Potongan seperti 'bukan pembeli baru' menggantung: "
        "pembaca tidak diberi tahu apa bedanya dan kenapa itu penting. Kalau "
        "judulnya menyebut JENIS pergerakan, sebutkan sekalian AKIBATNYA "
        "dengan kata biasa — 'kenaikan yang gampang kehabisan tenaga', "
        "'tekanan yang masih akan berlanjut'.\n"
        ...
        "yang tertutup, bukan pembeli baru' — istilah meja dagang, dan "
        "pembaca tidak pernah diberi tahu apa akibatnya.\n"
        "    Buruk (kaku dan bertumpuk): 'BTC melonjak 7% ke $78.275 didorong "
        "optimisme regulasi, tapi ditopang penutupan taruhan turun yang "
        "rapuh' — kata 'taruhan turun' tidak dipakai siapa pun, dan dua sebab "
        "yang disambung 'tapi' membuat kalimatnya harus dibaca dua kali.\n"
        "    Baik: 'BTC naik 7% ke $78.275 karena posisi jual ditutup, "
        "kenaikan yang gampang kehabisan tenaga' — mekanismenya disebut "
        "dengan kata biasa, dan akibatnya langsung diberitahukan.\n"
        "    Baik juga: 'Dua hari beruntun arus keluar ETF menahan BTC di "
        "bawah $65.000'; 'BTC nyaris tak bergerak menjelang notulen FOMC, "
        "rentang hariannya tersempit dalam sebulan'.\n"
        ...
        "(pakai `pergerakan_24j.jenis` — pembelian baru, penutupan posisi "
        "jual, posisi jual baru, atau posisi beli yang keluar; kosakata di "
        "aturan `judul` berlaku di sini juga) DAN apa artinya "
        ...
        "    KEBIJAKAN AS DAN GEOPOLITIK MASUK DI SINI, bukan sebagai bab "
        "terpisah: tempatnya sebagai SEBAB naik atau turunnya harga. Tulis "
        "sebab-akibatnya konkret — misalnya 'Selat Hormuz dibuka kembali, "
        "premi risiko energi turun' dengan arah naik — bukan sekadar "
        "menyebut topiknya. Ambil hanya dari `berita` dan "
        "`pernyataan_tokoh` yang diberikan.\n"
        "    Tiap berita dan pernyataan membawa field `mendarat`, yaitu di "
        "fase mana pasar AS berada saat kabar itu terbit. Pakai untuk "
        "menimbang keyakinan: kabar yang mendarat saat bursa buka sudah "
        "sempat dihargai pasar, sedangkan yang mendarat di jeda akhir pekan "
        "belum diserap arus institusi dan efeknya mungkin masih menunggu.\n"
